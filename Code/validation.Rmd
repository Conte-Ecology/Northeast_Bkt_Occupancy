...
# pred.fit2 <- predict(glmm.M32, df.fit, allow.new.levels = TRUE, type = "response") # identical
# pred.fit3 <- predict(glmm.M32, df.fit, allow.new.levels = TRUE, type = "response", re.form = NULL) # identical
# pred.fit4 <- predict(glmm.M32, df.fit, allow.new.levels = FALSE, type = "response", re.form = NULL) # identical
...
ne_map <- get_map(ne_coords, source = "stamen", maptype = c("terrain"), crop = T)
