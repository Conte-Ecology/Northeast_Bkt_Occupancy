...
setnames(summary_fixed, "rn", "Parameter")
...
g <- ggplot(df_preds, aes(conte_pred, dss_pred)) + geom_point(alpha = 0.5, colour = "gray50") + geom_abline(intercept = 0, slope = 1, colour = "red") + theme_bw()
g + geom_density2d()
